  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      >
        ...
        <div
          className={clsx(
            "faq-icon relative flex items-center size-12 justify-center border-2 rounded-full border-s2 shadow-400 transition-all duration-500 group-hover:border-s4",
